...
@section('title', 'Relatorios - HelpSub')
...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.reports.generate') }}" target="_blank" class="space-y-6" x-data="{ reportType: '' }">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            @php
                $reports = [
                    ['type' => 'stock_summary', 'title' => 'Resumo do Estoque', 'desc' => 'Visão geral de todos os produtos com quantidades disponíveis, emprestadas e mínimos.', 'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'color' => 'emerald'],
